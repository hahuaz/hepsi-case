...
const onPlaceOrderSpy = jest.spyOn(cartIndex.methods, 'onPlaceOrder')

describe('cartIndex.vue', () => {
  let wrapper, store, actions

  beforeEach(() => {
    actions = {
      'cart/populateCart': jest.fn(),
    }
  ...
  test('should call onPlaceOrder when place order button clicked', async () => {
    await wrapper.find('button.place-order').trigger('click')

    expect(onPlaceOrderSpy).toBeCalled()
  })
})
